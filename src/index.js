  ...
  return (
    <main className="menu">
      ...
      {numPizzas > 0 ? (
        <>
          <p>
            Authentic Tashkent cuisine. You will be served with the help of
            experienced cookers, who are cooking delicious, organic, and most
            importantly Halal dishes
          </p>
...
function Pizza({ pizzaObj }) {
  return (
    <li className={`pizza ${pizzaObj.soldOut ? "sold-out" : ""}`}>
      <img src={pizzaObj.photoName} alt="pizza-salamino"></img>
      <div>
        <h3>{pizzaObj.name}</h3>
